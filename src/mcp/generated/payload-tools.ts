...
/**
 * Tools for creating Payload CMS 3.0 configurations
 * Auto-generated from Payload CMS type definitions
 */
...
export const createGlobalTool: MCPTool = {
  name: 'createGlobal',
...
export const createFieldTool: MCPTool = {
  name: 'createField',
...
export const createAuthTool: MCPTool = {
  name: 'createAuth',
...
export const createConfigTool: MCPTool = {
  name: 'createConfig',
  ...
  handler: 
        async (params: Record<string, unknown>): Promise<unknown> => {
          try {
            ...
            const collections = Array.isArray(params.collections) ? params.collections as string[] : [];
            const globals = Array.isArray(params.globals) ? params.globals as string[] : [];
